          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="max-w-3xl mb-12">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-gray-900 mb-6 animate-slideUp">
                Do lixo eletrônico ao <span className="text-primary">futuro sustentável</span>
              </h1>
              <p className="text-lg text-gray-600 mb-8 animate-slideUp animation-delay-100">
                Transformamos resíduos eletrônicos e biomassas amazônicas em soluções ecológicas para construção, design
                e indústria.
              </p>
            ...
            {/* Image - Now centered below the content */}
            <div className="relative w-full max-w-2xl animate-fadeIn animation-delay-300">
              ...
              <div className="relative z-10 bg-white p-2 rounded-2xl shadow-2xl rotate-1 hover:rotate-0 transition-transform duration-500 mx-auto">
                <Image
                  src="/images/hero-image.png"
                  alt="Produtos sustentáveis AruaTech"
                  width={600}
                  height={400}
                  className="rounded-xl"
                  priority
                />
                <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-white/90 backdrop-blur-sm px-8 py-4 rounded-full shadow-xl border border-primary/20">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container">
          <div className="section-header">
            ...
            <p>O plástico que polui nossos rios pode virar um tijolo que abriga famílias</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <ul className="space-y-4">
                  {["Economia circular aplicada", "Bioeconomia amazônica", "Produtos com desempenho superior"].map(
                    (item, index) => (
                      <li key={index} className="flex items-start">
